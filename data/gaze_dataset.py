...
class gazeDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.add_argument('--path_A', type=str, default="/4Tdisk/fjl/dataset/mpii_recon_all.h5", help='# of gen filters in the last conv layer')
        parser.add_argument('--path_B', type=str, default="/4Tdisk/fjl/dataset/MPII_H5_single_evaluation/P*.h5", help='# of gen filters in the last conv layer')
    ...
    def __getitem__(self, index):
        ...
        return {'A': data_A, 'label_A':data_A_label, 'pose_A':data_A_pose, 'B': data_B, 'label_B':data_B_label, 'pose_B':data_B_pose}
